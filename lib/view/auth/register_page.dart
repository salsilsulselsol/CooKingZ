...
class _RegisterPageState extends State<RegisterPage> {
  ...
  final List<String> _cookingLevels = ['Pemula', 'Menengah', 'Lanjutan', 'Professional'];
    ...
    try {
      final response = await http.post(
        ...
        body: jsonEncode(<String, String>{
          ...
          'full_name': _fullNameController.text, // ✅ FIX di sini
          ...
          content: Column(
            ...
            children: [
              Container(
                ...
                child: const Icon(Icons.person_outline, size: 60, color: Color(0xFF015551)),
              ),
              const SizedBox(height: 20),
              const Text(
                "Daftar Akun\nBerhasil",
          ...
          content: Column(
            ...
            children: [
              ...
              ElevatedButton(
                ...
                child: const Text("Tutup", style: TextStyle(color: Colors.red, fontSize: 18)),
              ),
            ],
          ),
        );
